...
namespace ConsoleApp1
{
    ...
    class InputData
    {
        public InputData(double pl, double pl2, double em, double em2, (double, double, double) tea)
        {
            Pl = pl;
            Pl2 = pl2;
            Em = em;
    ...
    internal class Program
    {
        ...
        static void OOP(ref List<(double, double, double)> result)
        {
            ...
            var trainings = new InputData[] {
                ...
                new InputData(100, 10,100,100,(0,1,0)),
                new InputData( 10,100,100,100,(0,1,0)),
                new InputData( 10, 10, 10,10 ,(1,0,0)),
                new InputData( 10, 10,100, 50,(0,1,0)),
                new InputData( 10,100, 10,100,(0,1,0)),
                new InputData( 90, 90, 50,100,(1,0,0)),
                new InputData( 30, 10,100,100,(0,1,0)),
                new InputData(100,100, 20, 90,(1,0,0)),
                new InputData( 70,100, 10,100,(1,0,0)),
                new InputData( 10,100, 50,100,(0,1,0)),
                new InputData( 90, 90, 30,100,(1,0,0)),
                new InputData( 50, 50,100,100,(0,1,0)),
                new InputData( 50, 50, 50,100,(0,1,0)),
                new InputData( 40, 40, 50,100,(0,1,0)),
                new InputData( 80, 70, 70,100,(1,0,0))
            }.ToList();

            // テスト用XOR入力
            // 入力1(X),入力2(Y)
            var tests = new InputData(90, 9, 70, 100, (0, 1,0));
